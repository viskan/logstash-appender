...
public class LogstashAppenderTest extends Assert
{
    ...
    public void test_empty_static_parameters() throws Exception
    {
        ...
        try (DatagramSocket socket = new DatagramSocket(12345))
        {
            ...
            String actual = new String(received, 0, packet.getLength());
            String expected = "{\"message\":\"Test empty static keys!\",\"name\":\"com.viskan.log4j.logstash.appender.LogstashAppenderTest\",\"severity\":400,\"severityText\":\"INFO\"}";
    ...
    {
        return "{\"message\":\"Some message\",\"name\":\"com.viskan.log4j.logstash.appender.LogstashAppenderTest\",\"severity\":200,\"severityText\":\"ERROR\",\"application\":\"Test\",\"environment\":\"Development\",\"className\":\"com.viskan.log4j.logstash.appender.LogstashAppenderTest$LoggerTask\",\"lineNumber\":211,\"stacktrace\":\"java.lang.Exception: Error"
            + SEP + "\\tat com.viskan.log4j.logstash.appender.LogstashAppenderTest$LoggerTask.run(LogstashAppenderTest.java:211)" + SEP + "\\tat java.lang.Thread.run(Thread.java:748)" + SEP
            + "\",\"key2\":\"value2\"}";
    }

    private String getExpectedWithoutDetails()
    {
        return "{\"message\":\"Hello World!\",\"name\":\"com.viskan.log4j.logstash.appender.LogstashAppenderTest\",\"severity\":400,\"severityText\":\"INFO\"}";
    }
